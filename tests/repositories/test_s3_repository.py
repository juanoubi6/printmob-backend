...
from tests.test_utils.mock_entities import MOCK_FILE
...
class TestS3Repository(unittest.TestCase):
    ...
    def test_upload_file_returns_generated_image_url_on_success(self):
        ...
        response = self.s3_repository.upload_file(MOCK_FILE, "keyOfThe/image")
    ...
    def test_upload_file_raises_server_exception_on_s3_failure(self):
        ...
        with pytest.raises(ServerException):
            self.s3_repository.upload_file(MOCK_FILE, "keyOfThe/image")
